		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        ...
		        <li>
		        	<a class="nav-link" href="<?=base_url('#')?>">Registrar</a>
		        </li>		        
		        <li class="nav-item">
					  ...
					  <div class="card-body">
					   <form method="post" autocomplete="off" action="<?=base_url('welcome/loginnow')?>">
						  ...
						  <div class="mb-3">
						    ...
						    <input type="email"  placeholder="Correo Electrónico" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
						  </div>
						  <div class="mb-3">
